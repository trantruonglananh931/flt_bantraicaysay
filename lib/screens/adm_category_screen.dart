...
class AdmCategoryScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // Lấy AuthProvider từ Provider
            ...
            onPressed: () {
              ...
              if (token != null) {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => CategoryFormScreen(token: token),
                  ),
                );
              } else {
                                  ...
                                  try {
                                    ...
                                    if (token != null) {
                                      await Provider.of<CategoryProvider>(context, listen: false)
                                          .deleteCategory(token, category.id!.toString());
                                      ScaffoldMessenger.of(context).showSnackBar(
